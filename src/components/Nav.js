                ...
                <li className='home'>
                    <Link to={`/${userType}/home`}>
                        <figure className={isActive('home')}>
                            <img src="/img/nav/home_off.svg" alt="홈 버튼" />
                            <img src="/img/nav/home_on.svg" alt="홈 버튼" />
                ...
                <li className='schedule'>
                    <Link to="/error">
                        <figure className={isActive('schedule')}>
                            <img src="/img/nav/schedule_off.svg" alt="스케줄 버튼" />
                            <img src="/img/nav/schedule_on.svg" alt="스케줄 버튼" />
                ...
                <li className='note'>
                    <Link to={`/${userType}/note`}>
                        <figure className={isActive('note')}>
                            <img src="/img/nav/note_off.svg" alt="채팅 버튼" />
                            <img src="/img/nav/note_on.svg" alt="채팅 버튼" />
                ...
                <li className='chat'>
                    <Link to="/error">
                        <figure className={isActive('chat')}>
                            <img src="/img/nav/chat_off.svg" alt="채팅 버튼" />
                            <img src="/img/nav/chat_on.svg" alt="채팅 버튼" />
                ...
                <li className='management'>
                    <Link to="/error">
                        <figure className={isActive('management')}>
                            <img src="/img/nav/management_off.svg" alt="회원 관리 버튼" />
                            <img src="/img/nav/management_on.svg" alt="회원 관리 버튼" />
                ...
                <li className='my'>
                    <Link to={`/${userType}/my`}>
                        <figure className={isActive('my')}>
                            <img src="/img/nav/my_off.svg" alt="마이 버튼" />
                            <img src="/img/nav/my_on.svg" alt="마이 버튼" />
